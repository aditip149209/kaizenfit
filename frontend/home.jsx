  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#101c1c', fontFamily: "'Montserrat', sans-serif", color: '#e7f6f2', margin: 0 }}>
      ...
      <div style={styles.sidebar}>
        <a href="dashboard.html" style={styles.icon}>
          <img src="icons/KaizenLogo.png" alt="Logo" style={{ width: '22px', height: '22px' }} />
        </a>
        <a href="home.html" style={styles.icon}>
          <img src="icons/home.png" alt="Home" style={{ width: '22px', height: '22px' }} />
        </a>
        <a href="stats.html" style={styles.icon}>
          <img src="icons/stats.png" alt="Analytics" style={{ width: '22px', height: '22px' }} />
        </a>
        <a href="diet.html" style={styles.icon}>
          <img src="icons/meal.png" alt="Diet" style={{ width: '22px', height: '22px' }} />
        </a>
        <a href="settings.html" style={styles.icon}>
          <img src="icons/settings.png" alt="Settings" style={{ width: '22px', height: '22px' }} />
        </a>
        <a href="logout.html" style={styles.icon}>
          <img src="icons/logout.png" alt="Logout" style={{ width: '22px', height: '22px' }} />
        </a>
      </div>
      ...
      <div style={{ flex: 1, padding: '40px 0 40px 40px', display: 'flex', flexWrap: 'wrap', gap: '30px' }}>
        ...
        <div style={{ flex: 3, display: 'flex', flexDirection: 'column', gap: '25px' }}>
          ...
          <div style={styles.cardsGrid}>
            ...
            <div style={styles.card}>
              ...
              <button style={{ ...styles.btn, background: '#7ed6c0', color: '#182828' }}>MARK AS COMPLETED</button>
            </div>
            ...
            <div style={styles.card}>
              ...
              <div style={styles.myWorkoutsList}>
                <div style={styles.workoutRow}>
                  <span>Leg Day</span>
                  <span>
                    45 min <button style={styles.editBtn}>Edit</button>
                  </span>
                </div>
                <div style={styles.workoutRow}>
                  <span>Back</span>
                  <span>
                    35 min <button style={styles.editBtn}>Edit</button>
                  </span>
                </div>
                <div style={styles.workoutRow}>
                  <span>Upper Body</span>
                  <span>
                    25 min <button style={styles.editBtn}>Edit</button>
                  </span>
                </div>
                <div style={styles.workoutRow}>
                  <span>Glutes</span>
                  <span>
                    50 min <button style={styles.deleteBtn}>Delete</button>
                  </span>
                </div>
              </div>
              <button style={{ ...styles.btn, marginTop: 12, background: '#e74c3c' }}>Delete Workout</button>
            </div>
          </div>
        </div>
        ...
        <div style={styles.sidePanel}>
          ...
          <div style={styles.heartRateSection}>
            ...
            <div style={{ fontSize: '0.94rem', color: '#b2dfdb' }}>Resting</div>
            <button style={styles.editGoalBtn}>Sync Device</button>
          </div>
          {/* Steps */}
